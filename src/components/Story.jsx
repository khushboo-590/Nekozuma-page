...
const Story = () => {
    return (
        <section id="story" className="bg-[#1C2430] text-white pt-8 lg:pt-12">
            <div className="max-w-[1920px] mx-auto ">
                    <Customheading title="Story" myClass="flex justify-center items-center" />
                <div className="max-w-[888px] mx-auto pt-6 text-center text-[#D4E5FF] font-family-sarabun">
            ...
            <div className="flex justify-center mt-[30px] lg:mt-[58px]">
