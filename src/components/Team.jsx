      ...
      <section className='bg-[#1C2430]'>
          <div class="container mx-auto pt-16 max-w-[1140px]">
              <div class="flex items-center justify-center flex-col">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-[36px]">
                          ...
                          <div key={index} className="p-4">
                              <div className="p-6 text-center">
                                  <img
                                      src={item.image}
                                      alt={item.title}
                                      className="mx-auto w-full max-w-[290px] sm:max-w-[202px] h-auto sm:h-[202px] object-cover"/>
